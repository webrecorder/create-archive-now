...
// ===========================================================================
replaywebpage__WEBPACK_IMPORTED_MODULE_0__.Embed.setDefaultReplayFile("replay.html");
// ===========================================================================
class RecordEmbed extends replaywebpage__WEBPACK_IMPORTED_MODULE_0__.Embed {
    constructor() {
        super();
    ...
    static get properties() {
        return Object.assign(Object.assign({}, replaywebpage__WEBPACK_IMPORTED_MODULE_0__.Embed.properties), { archivePrefix: { type: String }, proxyPrefix: { type: String } });
    }
    randomId() {
    ...
    getDownloadUrl() {
        return `${replaywebpage__WEBPACK_IMPORTED_MODULE_0__.apiPrefix}/c/${this.coll}/dl?format=wacz&pages=all`;
    }
    handleMessage(event) {

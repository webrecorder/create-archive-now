...
const T={attribute:!0,type:String,converter:L,reflect:!1,hasChanged:A},U=(e=T,t,i)=>{const{kind:o,metadata:r}=i;let s=globalThis.litPropertyMetadata.get(r);if(void 0===s&&globalThis.litPropertyMetadata.set(r,s=new Map),s.set(i.name,e),"accessor"===o){const{name:o}=i;return{set(i){const r=t.get.call(this);t.set.call(this,i),this.requestUpdate(o,r,e)},init(t){return void 0!==t&&this.P(o,void 0,e),t}}}if("setter"===o){const{name:o}=i;return function(i){const r=this[o];t.call(this,i),this.requestUpdate(o,r,e)}}throw Error("Unsupported decorator location: "+o)};function D(e){return(t,i)=>"object"==typeof i?U(e,t,i):((e,t,i)=>{const o=t.hasOwnProperty(i);return t.constructor.createProperty(i,o?{...e,wrapped:!0}:e),o?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}var O=__webpack_require__(431),R=__webpack_require__.n(O),F=__webpack_require__(242),M=__webpack_require__.n(F);class q extends i.q7{constructor(){super(...arguments),this.sourceUrl=null,this.shareOpts={},this.showFinish=!0,this.totalSize=0,this._sizeUpdater=null}static get styles(){return(0,i.KI)(q.compStyles)}static get compStyles(){return i.AH`
    ...
    `}updated(e){var t;super.updated(e),(e.has("embed")||(e.has("item")||e.has("loadInfo"))&&this.loadInfo&&this.embed&&this.item&&!this._sizeUpdater)&&(this._sizeUpdater=this.runSizeUpdater()),e.has("favIconUrl")&&this.favIconUrl&&(null===(t=navigator.serviceWorker.controller)||void 0===t||t.postMessage({msg_type:"update-favicon",id:this.item,url:this.tabData.url,favIconUrl:this.favIconUrl.split("mp_/")[1]}))}runSizeUpdater(){return t(this,void 0,void 0,(function*(){try{for(;this.embed;){if(this.item){const e=yield fetch(`${i.P8}/c/${this.item}`),t=yield e.json();this.totalSize=t.size||0}yield new Promise((e=>setTimeout(e,3e3)))}}finally{this._sizeUpdater=null}}))}renderToolbarLeft(e=!1){const t=super.renderToolbarLeft();return this.embed?t:i.qy`${t}<a
      ...
      ${this.showFinish?i.qy` <button class="button is-primary" @click="${this.onEmbedFinish}" type="button">Finish</button>`:i.qy`
            ...
            >
          `}
    `:e}renderCollInfo(){return i.qy` <div class="info-bg">
      <wr-rec-coll-info
        class="is-list"
        .item="${this.itemInfo}"
